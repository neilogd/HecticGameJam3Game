...
void GaPlayerComponent::StaticRegisterClass()
{
	ReField* Fields[] =
	{
		...
		new ReField( "ViewMatrix_", &GaPlayerComponent::ViewMatrix_, ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "TargetPosition_", &GaPlayerComponent::TargetPosition_, ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "PlayerState_", &GaPlayerComponent::PlayerState_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "OriginalSize_", &GaPlayerComponent::OriginalSize_, ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "JumpHeight_", &GaPlayerComponent::JumpHeight_, ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "JumpTimer_", &GaPlayerComponent::JumpTimer_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "JumpSpeed_", &GaPlayerComponent::JumpSpeed_, ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "JumpStart_", &GaPlayerComponent::JumpStart_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "JumpEnd_", &GaPlayerComponent::JumpEnd_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "CannonTimer_", &GaPlayerComponent::CannonTimer_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "CannonSpeed_", &GaPlayerComponent::CannonSpeed_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "CannonSuckDistance_", &GaPlayerComponent::CannonSuckDistance_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "CannonStart_", &GaPlayerComponent::CannonStart_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "CannonEnd_", &GaPlayerComponent::CannonEnd_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "TankIndex_", &GaPlayerComponent::TankIndex_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		...
		new ReField( "ShownNextMessage_", &GaPlayerComponent::ShownNextMessage_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
		new ReField( "TimeSinceStart_", &GaPlayerComponent::TimeSinceStart_, bcRFF_TRANSIENT | ReFieldFlags::bcRFF_DEBUG_EDIT ),
